...
`
	...
	if got.Repository != "repoid://github.com/owner/repo" || got.BaseBranch != "staging" || got.Command != "go test ./..." || got.PolicySHA256 != "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef" {
...
func TestLoadGlobalBootstrapTestBindingRefusesAmbiguousDuplicate(t *testing.T) {
	path := filepath.Join(t.TempDir(), "config.yaml")
	binding := `    - repository: repoid://github.com/owner/repo
      base_branch: staging
      command: go test ./...
...
func TestLoadGlobalBootstrapTestBindingRefusesMissingAndMalformedFields(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "missing base", body: "repository: repoid://github.com/owner/repo\n      command: go test ./...\n      policy_sha256: " + validDigest},
		{name: "missing command", body: "repository: repoid://github.com/owner/repo\n      base_branch: staging\n      policy_sha256: " + validDigest},
		{name: "missing digest", body: "repository: repoid://github.com/owner/repo\n      base_branch: staging\n      command: go test ./..."},
		{name: "noncanonical repository", body: "repository: https://github.com/owner/repo.git\n      base_branch: staging\n      command: go test ./...\n      policy_sha256: " + validDigest},
		{name: "noncanonical envelope", body: "repository: repoid://github.com/Owner/Repo\n      base_branch: staging\n      command: go test ./...\n      policy_sha256: " + validDigest},
		{name: "full ref base", body: "repository: repoid://github.com/owner/repo\n      base_branch: refs/heads/staging\n      command: go test ./...\n      policy_sha256: " + validDigest},
		{name: "whitespace command", body: "repository: repoid://github.com/owner/repo\n      base_branch: staging\n      command: ' go test ./...'\n      policy_sha256: " + validDigest},
		{name: "malformed digest", body: "repository: repoid://github.com/owner/repo\n      base_branch: staging\n      command: go test ./...\n      policy_sha256: xyz"},
		{name: "uppercase digest", body: "repository: repoid://github.com/owner/repo\n      base_branch: staging\n      command: go test ./...\n      policy_sha256: " + strings.Repeat("A", 64)},
	} {
