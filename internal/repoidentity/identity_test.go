...
func TestCanonicalIsIdempotent(t *testing.T) {
	for _, tc := range []struct {
		...
		{name: "SCP", raw: "git@Git.Example.test:Group/Repo.git", want: "repoid+ssh-rel://git@git.example.test/Group/Repo"},
		{name: "SCP numeric namespace", raw: "git@Git.Example.test:123/Repo.git", want: "repoid+ssh-rel://git@git.example.test/123/Repo"},
		{name: "SCP IPv6", raw: "git@[2001:0db8::1]:Group/Repo.git", want: "repoid+ssh-rel://git@[2001:db8::1]/Group/Repo"},
		...
		{name: "SSH default port", raw: "ssh://git@Git.Example.test:22/Group/Repo.git", want: "repoid+ssh-abs://git@git.example.test/Group/Repo"},
		...
		{name: "SSH non-default 443", raw: "ssh://git@Git.Example.test:443/Group/Repo.git", want: "repoid+ssh-abs://git@git.example.test:443/Group/Repo"},
